...
//    <nav className={`container mx-auto flex items-center justify-between py-4 px-6 z-50 ${stickyNav ? "fixed  top-0 right-0 left-0" : "p-1"}`}>
...
//       <button onClick={toggleNavDrawer} className='rounded-md'>
    ...
    <>
      ...
      <nav
        className={`w-full transition-all duration-300 ${
          stickyNav
            ? 'fixed top-0 left-0 right-0 bg-white shadow-md z-50 p-2'
            : 'relative bg-transparent'
        }`}
      >
        {/* ✅ container stays inside, not fixed */}
