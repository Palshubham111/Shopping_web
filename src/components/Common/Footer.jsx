...
const Footer = () => {
  return (
    ...
    <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
      <div className='ml-5'>
        ...
        <p className='text-gray-500 mb-4'>
          Be the first hear new products, exclusive events, and online offers.
        </p>
        <p className='font-medium text-sm text-gray-600 mb-6'>
          sign up and get 10% off your first order
        </p>
        <form className='flex'>
          <input type="email" placeholder='enter your email ' className='p-3 w-full text-sm border-1 border-b border-gray-300  rounded-l-md focus:outline-none focus:ring-gray-500 transition-all' required />
    ...
    <div className='container mx-auto mt-12 px-4lg:px-0 border-t border-gray-200 pt-6'></div>
